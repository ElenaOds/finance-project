...
# Finance tickers quoting online

## Requirements

Finance tickers is a solution that displays price tickers data on the UI in realtime.

Price data is available from a locally running service. After updating the percentage increasement / decreasement is highlighted with green / red color and appropriate arrows
...
Project is available on Master branch (GitHub)
